...
export async function GET() {
  try {
    ...
    const sportsData = (settings.sportsData as Record<string, unknown>) ?? {};

    return NextResponse.json({
      success: true,
      data: {
        totalStudents: students,
        sportsAvailable: sportsData.sportsAvailable || [],
        upcomingCompetitions: sportsData.upcomingCompetitions || [],
        medalsWon: sportsData.medalsWon || [],
        awards: sportsData.awards || [],
        sportsAttendance: sportsData.sportsAttendance || [],
        medalDistribution: sportsData.medalDistribution || [],
