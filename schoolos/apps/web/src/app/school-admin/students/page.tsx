  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Dashboard', href: '/school-admin/dashboard' }, { label: 'Students' }]}
      />
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="mt-2 text-sm text-muted-foreground text-center max-w-md">
            Student management module is under development. You can manage staff in the meantime.
          </p>
