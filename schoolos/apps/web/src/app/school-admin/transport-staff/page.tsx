  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Manage transport department staff"
        breadcrumbs={[{ label: 'Dashboard', href: '/school-admin/dashboard' }, { label: 'Transport Staff' }]}
      />
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="mt-2 text-sm text-muted-foreground text-center max-w-md">
            Manage transport department staff
          </p>
