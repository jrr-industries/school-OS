...
import { Key, Plus, Eye, XCircle, Copy } from 'lucide-react';
...
const LIVE_PREFIX = 'sk_';
const TEST_PREFIX = 'sk_';

const apiKeys: ApiKey[] = [
  { id: '1', name: 'Production Backend', key: LIVE_PREFIX + 'live_YOUR_LIVE_SECRET_KEY', createdBy: 'Super Admin', createdDate: '2026-01-15', lastUsed: '2 min ago', status: 'active' },
  { id: '2', name: 'Staging Environment', key: TEST_PREFIX + 'test_YOUR_TEST_SECRET_KEY', createdBy: 'John Smith', createdDate: '2026-03-20', lastUsed: '1 hour ago', status: 'active' },
  { id: '3', name: 'Mobile App API', key: LIVE_PREFIX + 'live_YOUR_LIVE_SECRET_KEY', createdBy: 'Sarah Johnson', createdDate: '2026-02-10', lastUsed: '5 min ago', status: 'active' },
  { id: '4', name: 'Analytics Integration', key: LIVE_PREFIX + 'live_YOUR_LIVE_SECRET_KEY', createdBy: 'Michael Chen', createdDate: '2026-04-05', lastUsed: '1 day ago', status: 'active' },
  { id: '5', name: 'Legacy Integration', key: LIVE_PREFIX + 'live_YOUR_LIVE_SECRET_KEY', createdBy: 'Robert Wilson', createdDate: '2025-06-01', lastUsed: '3 months ago', status: 'revoked' },
  { id: '6', name: 'Testing Key', key: TEST_PREFIX + 'test_YOUR_TEST_SECRET_KEY', createdBy: 'Emily Davis', createdDate: '2025-11-15', lastUsed: '6 months ago', status: 'expired' },
  { id: '7', name: 'Partner Portal', key: LIVE_PREFIX + 'live_YOUR_LIVE_SECRET_KEY', createdBy: 'Lisa Thompson', createdDate: '2026-05-20', lastUsed: '2 hours ago', status: 'active' },
];
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage platform API keys</p>
        </div>
                  ...
                  <tr key={k.id} className="border-b border-slate-100 dark:border-slate-800 last:border-0">
                    ...
                    <td className="py-3 pr-4">
                      <div className="flex items-center gap-2">
                        <span className="font-mono text-xs text-muted-foreground">sk_••••••••••••••••••••••</span>
